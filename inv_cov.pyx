...
# @cython.boundscheck(False)
# @cython.wraparound(False)
# cdef void invCovMats_cdef(int TR, int N, int k, double* p_Covs, double* p_Lout, double* p_invCov, int* p_kinfo):
#     """
#     vCovs     - the fV array
#     vLout     - provide this
#     vCovsOut  - provide this
#     """
#     cdef int* p_b = <int*>malloc(sizeof(int)*k)
#     cdef double* p_Li = <double*>malloc(k*k*sizeof(double))
#     cdef double* p_eachL = <double*>malloc(k*k*sizeof(double))
#     cdef double* p_eachLdiag = <double*>malloc(k*k*sizeof(double))
