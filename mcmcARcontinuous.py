...
if hpf:
    info  = mne.create_info(["eeg"], 1000, ch_types="eeg")#, montage="standard_1020")
...
radians      = buildLims(Cn, freq_lims, nzLimL=0.00001)
...
#     if ram:
#         uts[itstore], wts[itstore] = _arcfs.ARcfSmpl(N, k, 1, AR2lims, smpx_contiguous1, smpx_contiguous2, q2, R, Cs, Cn, alpR, alpC, sig_ph0L, sig_ph0H, 0.05*0.05)
#     else:
