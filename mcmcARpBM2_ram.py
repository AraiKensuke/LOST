...
class mcmcARpBM2(mcmcARspk.mcmcARspk):
    ...
    def dirichletAllocate(self):  ###########################  GIBBSSAMP
        ...
        while (it < ooNMC + oo.burn - 1):
            ...
            tpl_args = zip(oo._d.y, oo._d.Rv, oo._d.Fs, _N.linalg.inv(oo._d.Fs, ), oo.q2, oo._d.Ns, oo._d.ks, oo._d.f_x[:, 0], oo._d.f_V[:, 0])
            ...
            ###  
            if not oo.bFixF:   
                ARcfSmpl(oo.lfc, ooN+1, ook, oo.AR2lims, oo.smpx[:, 1:, 0:ook], oo.smpx[:, :, 0:ook-1], oo.q2, oo.R, oo.Cs, oo.Cn, alpR, alpC, oo.TR, prior=oo.use_prior, accepts=80, aro=oo.ARord, sig_ph0L=oo.sig_ph0L, sig_ph0H=oo.sig_ph0H)  
